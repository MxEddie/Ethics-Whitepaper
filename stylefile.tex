...
%\runningtitle{Survey of Methods for Low-resource Machine Translation}

%\runningauthor{Odi\'e N. Gementera}

%\begin{document}

\title{Survey of Methods for Low-Resource Machine Translation}
...
\author{Jind$\hat{\text{r}}$a Helcl}
\affil{University of Edinburgh}

\maketitle

\begin{abstract}
We present a summary proposal covering the state of the art in area of machine translation related to low resource languages. As there are only a few language pairs where there is a large amount of translated data available for training machine translation models, the low resource scenario applies to almost all language pairs. There has been a wide ranage of research addressing this problem, from work aimed at extracting translated data from web crawled data to advances in cross lingual representation learning. We will cover at a high level the most important work for each type of approach. 
\end{abstract}

\section{Data Gathering}

\section{Data Augmentation}
\section{Multilingual Methods}
